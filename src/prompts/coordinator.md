...
- Clear Phase Objectives: the test plan must clearly define and record the concrete design goal and expected effect of each phase, avoiding vague descriptions. If the expected coverage improvement is not achieved, these phase objectives provide a basis for diagnosis and adjustment.
